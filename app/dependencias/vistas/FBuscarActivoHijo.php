...
<div id="content-wrapper">
    <div id="contenido">
        <div class="container-fluid">
            <div id="seccionSuperior" class="form-row mt-3">
                <div class="col text-left">
                    <h4><i class="fas fa-list"></i> BUSCAR ACTIVO HIJO</h4>
                </div>
            </div>
            <div class="mt-3 mb-4">
                <form method="POST" id="formBuscarActivoHijo" name="formBuscarActivoHijo">
                    ...
                    <div class="form-row mt-2">
                        <div class="col text-right">
                            ...
                            <a href="FCrearActivoHijo.php" title="Ir al formulario de creación">
        ...
        <div class="modal fade" id="ModalCambioEstadoActivoHijo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg border-azul-clasico">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="mceaCuerpo">
                        <form id="formCambiarEstadoActivoHijo" name="formCambiarEstadoActivoHijo" method="POST">
                            <input type="hidden" name="mceaAccion" id="mceaAccion">
                            <input type="hidden" name="mceaIdActivoHijo" id="mceaIdActivoHijo">
                            <div class="form-row">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success"
                                name="btnCambiarEstadoActivoHijo" id="btnCambiarEstadoActivoHijo">
...
<script type="text/javascript" src="../js/BuscarActivoHijo.js"></script>
