        ...
        <div class="container-fluid">
            <div id="seccionSuperior" class="form-row mt-3">
                <div class="col text-left">
                    <h4><i class="fas fa-code"></i> BUSCAR LENGUAJE DE PROGRAMACIÓN</h4>
                </div>
            </div>
            <div class="mt-3 mb-4">
                <form method="POST" id="formBuscarLenguaje" name="formBuscarLenguaje">
                    ...
                    <div class="form-row mt-2">
                        <div class="col text-right">
                            ...
                            <a href="FCrearLenguaje.php" title="Ir al formulario de creación">
            ...
            <div class="modal-dialog modal-lg border-azul-clasico">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="mcelCuerpo">
                        <form id="formCambiarEstadoLenguaje" name="formCambiarEstadoLenguaje" method="POST">
                            <input type="hidden" name="mcelAccion" id="mcelAccion">
                            <input type="hidden" name="mcelIdLenguaje" id="mcelIdLenguaje">
                            <div class="form-row">
