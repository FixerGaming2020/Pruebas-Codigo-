...
if ($_POST['idAplicacion']) {
    ...
    $modificacion = $controlador->modificarPP($id, $sigla, $nombre, $tipo, $seguridad, $tecnologia, $proveedor, $lenguaje, $herramienta, $base, $modo, $lugar, $plataforma, $empleado, $sDesarrollo, $pDesarrollo, $rti, $descripcion);
