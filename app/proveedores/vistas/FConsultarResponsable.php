        ...
        <div class="container-fluid">
            <div id="seccionSuperior" class="form-row mt-3">
                <div class="col text-left">
                    <h4><i class="far fa-address-card"></i> CONSULTAR RESPONSABLE</h4>
                </div>
            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <input type="text" class="form-control mb-2" 
                                           ...
                                           title="Nombre del contacto: campo no obligatorio"
                                           placeholder="Nombre del contacto">
                                </div>
                                <label for="proveedor" class="col-2 col-form-label text-left">Proveedor:</label>
                                <div class="col">
                                    <input type="text" class="form-control mb-2" 
                                           name="proveedor" id="proveedor" maxlength="10"
...
<script type="text/javascript" src="../js/ConsultarResponsable.js"></script>