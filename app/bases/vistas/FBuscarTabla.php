            ...
            <div class="modal-dialog modal-lg border-azul-clasico">
                <div class="modal-content ">
                    ...
                    <div class="modal-body">
                        <div class="form-row">
                            <label class="col-sm-2 col-form-label">Base de datos:</label>
                            <div class="col">
                                <input type="text" class="form-control mb-2" 
                                       name="mdtBase" id="mdtBase" readonly>
                            </div>
                            <label class="col-sm-2 col-form-label">Nombre:</label>
                            <div class="col">
                                <input type="text" class="form-control mb-2" 
                                       name="mdtNombre" id="mdtNombre" readonly>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="col">
                                <input type="text" class="form-control mb-2" 
                                       name="mdtCreacion" id="mdtCreacion" readonly>
                            </div>
                            <label class="col-sm-2 col-form-label">Fecha edición:</label>
                            <div class="col">
                                <input type="text" class="form-control mb-2" 
                                       name="mdtEdicion" id="mdtEdicion" readonly>
                            </div>
                        </div>
                        <div class="form-row">
                            <label class="col-sm-2 col-form-label">Fecha proceso:</label>
                            <div class="col">
                                <input type="text" class="form-control mb-2"
                                       name="mdtProceso" id="mdtProceso" readonly>
                            </div>
                            <label class="col-sm-2 col-form-label"></label>
                            <div class="col"></div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="col">
                                <textarea class="form-control mb-2" 
                                          name="mdtDescripcion" id="mdtDescripcion" 
