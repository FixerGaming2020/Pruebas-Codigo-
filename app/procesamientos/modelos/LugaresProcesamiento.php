...
class LugaresProcesamiento {
    ...
    public static function listarUltimosCreados() {
        $consulta = "SELECT TOP(10) * FROM psa_lugar WHERE estado = 'Activo' ORDER BY id DESC";
    ...
    public static function seleccionar($nombre) {
        $consulta = "SELECT id, nombre FROM psa_lugar WHERE nombre LIKE ? AND estado = 'Activo'";
