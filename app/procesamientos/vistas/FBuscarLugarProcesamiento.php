...
<div id="content-wrapper">
    <div id="contenido">
        <div class="container-fluid">
            <div id="seccionSuperior" class="form-row mt-3">
                <div class="col text-left">
                    <h4><i class="fas fa-cogs"></i> BUSCAR LUGAR PROCESAMIENTO</h4>
                </div>
            </div>
            <div class="mt-3 mb-4">
                <form method="POST" id="formBuscarLugar" name="formBuscarLugar">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <input type="text" class="form-control mb-2" 
                                           ...
                                           title="Nombre del lugar: campo no obligatorio"
                    ...
                    <div class="form-row mt-2">
                        <div class="col text-right">
                            <button type="submit" class="btn btn-success" id="btnBuscarLugar" name="btnBuscarLugar">
                                <i class="fas fa-search"></i>  BUSCAR</button>
                            <a href="FCrearLugarProcesamiento.php" title="Ir al formulario de creación">
        ...
        <div class="modal fade" id="ModalCambioEstadoLugar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg border-azul-clasico">
                <div class="modal-content">
                    <div class="modal-header bg-azul-clasico text-white">
                        <h4 class="modal-title text-center" id="mcelTitulo"></h4>
                    </div>
                    <div class="modal-body" id="mcelCuerpo">
                        <form id="formCambiarEstadoLugar" name="formCambiarEstadoLugar" method="POST">
                            <input type="hidden" name="mcelAccion" id="mcelAccion">
                            <input type="hidden" name="mcelIdLugar" id="mcelIdLugar">
                            <div class="form-row">
                                <b><p id="mcelNombre" name="mcelNombre"></p></b>
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success"
                                name="btnCambiarEstadoLugar" id="btnCambiarEstadoLugar">
...
<script type="text/javascript" src="../js/BuscarLugarProcesamiento.js"></script>