...
<div id="content-wrapper">
    <div id="contenido">
        <div class="container-fluid">
            <div id="seccionSuperior" class="form-row mt-3">
                <div class="col text-left">
                    <h4><i class="fas fa-cogs"></i> BUSCAR MODO PROCESAMIENTO</h4>
                </div>
            </div>
            <div class="mt-3 mb-4">
                <form method="POST" id="formBuscarModo" name="formBuscarModo">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <input type="text" class="form-control mb-2" 
                                           ...
                                           title="Nombre del modo: campo no obligatorio"
                    ...
                    <div class="form-row mt-2">
                        <div class="col text-right">
                            <button type="submit" class="btn btn-success" id="btnBuscarModo" name="btnBuscarModo">
                                <i class="fas fa-search"></i>  BUSCAR</button>
                            <a href="FCrearModoProcesamiento.php" title="Ir al formulario de creación">
        ...
        <div class="modal fade" id="ModalCambioEstadoModo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg border-azul-clasico">
                <div class="modal-content">
                    <div class="modal-header bg-azul-clasico text-white">
                        <h4 class="modal-title text-center" id="mcemTitulo"></h4>
                    </div>
                    <div class="modal-body" id="mcemCuerpo">
                        <form id="formCambiarEstadoModo" name="formCambiarEstadoModo" method="POST">
                            <input type="hidden" name="mcemAccion" id="mcemAccion">
                            <input type="hidden" name="mcemIdModo" id="mcemIdModo">
                            <div class="form-row">
                                <b><p id="mcemNombre" name="mcemNombre"></p></b>
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success"
                                name="btnCambiarEstadoModo" id="btnCambiarEstadoModo">
...
<script type="text/javascript" src="../js/BuscarModoProcesamiento.js"></script>